...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference('Parcel.count') do
      post parcels_url, params: { parcel: { observation: @parcel.observation, value: @parcel.value } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { observation: @parcel.observation, value: @parcel.value } }
