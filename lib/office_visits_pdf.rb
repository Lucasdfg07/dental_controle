...
module OfficeVisitsPdf
  ...
  def self.office_visits office_visits
      Prawn::Document.new(PDF_OPTIONS) do |pdf|
        ...
        data = [["Id", "Pagamento", "Tratamento", "Valor cobrado", "Data da consulta"]]
        
        office_visits.each do |office_visit|
          @cont = @cont + 1
          data += [ [@cont, office_visit.payment_method, office_visit.treatment,  
                    office_visit.value, office_visit.date.to_s+" "+office_visit.hour ] ]
        end
